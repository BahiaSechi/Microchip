...
SOURCEFILES_QUOTED_IF_SPACED=../main.c ../../src/adc_init.c ../../src/adc_read.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/main.p1 ${OBJECTDIR}/_ext/1445274692/adc_init.p1 ${OBJECTDIR}/_ext/1445274692/adc_read.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/main.p1.d ${OBJECTDIR}/_ext/1445274692/adc_init.p1.d ${OBJECTDIR}/_ext/1445274692/adc_read.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/main.p1 ${OBJECTDIR}/_ext/1445274692/adc_init.p1 ${OBJECTDIR}/_ext/1445274692/adc_read.p1

# Source Files
SOURCEFILES=../main.c ../../src/adc_init.c ../../src/adc_read.c
...
${OBJECTDIR}/_ext/1445274692/adc_init.p1: ../../src/adc_init.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1445274692" 
	@${RM} ${OBJECTDIR}/_ext/1445274692/adc_init.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1445274692/adc_init.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite -O0 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 -I"../../../" --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1445274692/adc_init.p1 ../../src/adc_init.c 
	@-${MV} ${OBJECTDIR}/_ext/1445274692/adc_init.d ${OBJECTDIR}/_ext/1445274692/adc_init.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1445274692/adc_init.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/_ext/1445274692/adc_read.p1: ../../src/adc_read.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1445274692" 
	@${RM} ${OBJECTDIR}/_ext/1445274692/adc_read.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1445274692/adc_read.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite -O0 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 -I"../../../" --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1445274692/adc_read.p1 ../../src/adc_read.c 
	@-${MV} ${OBJECTDIR}/_ext/1445274692/adc_read.d ${OBJECTDIR}/_ext/1445274692/adc_read.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1445274692/adc_read.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
